    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('outer_image', models.ImageField(blank=True, null=True, upload_to=userauths.models.user_directory_path)),
                ('alt', models.CharField(blank=True, max_length=10000, null=True)),
